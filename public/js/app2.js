        ...
        this.loader.load(tank, (gltf) => {
            ...
            this.tank.traverse( m => {
                if (m.isMesh) {
                    ...
                    //if (instance%2===0) {m.material = new THREE.MeshStandardMaterial({ wireframe: true, color: 0x00ffff })}
                    gms.push(m.geometry)
                }
            })
            ...
            this.loader.load(sunflower, (gltf) => {
                //this.sunflower = gltf.scene.children[0] - for tree
